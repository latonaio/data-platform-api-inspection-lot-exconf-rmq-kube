...
import (
	"context"
	dpfm_api_caller "data-platform-api-inspection-lot-exconf-rmq-kube/DPFM_API_Caller"
	...
	"data-platform-api-inspection-lot-exconf-rmq-kube/config"
	"encoding/json"
	"fmt"
...
func dataCallProcess(
	...
	var input dpfm_api_input_reader.HeaderSDC
...
func getAccepter(input *dpfm_api_input_reader.HeaderSDC) []string {
